...
export default function Product() {
  ...
  return (
    <>
      <div id="nawbar">
        <div className="logo" onClick={() => setIsPlayed(false)}>
          <i
            className="fa-brands fa-youtube fa-4x"
            style={{ color: 'red', width: '100px', cursor: 'pointer' }}
          ></i>
        </div>
      ...
      <div className="prod-container prod-container-2">
        <div className="prod-yt-item">
          <div className="" style={{ position: 'relative', width: '100%' }}>
            <img
              src="/images/real-estate.jpeg"
              style={{ width: '100%', cursor: 'pointer', height: '100%' }}
              onClick={() => setIsPlayed(true)}
            ></img>
            <i
              className="fa-brands fa-youtube fa-4x yt-icon"
              onClick={() => setIsPlayed(true)}
            ></i>
          </div>
          <p onClick={() => setIsPlayed(true)}>
            INSIDE a real-estate Modern SMART HOME | Mansion Tour!
          </p>
        </div>
        <div className="yt-preview-wrapper">
          <div className="prod-yt-preview prod-yt-preview-2">
            <img
              onClick={() => setIsPlayed(true)}
              src="https://freepngimg.com/thumb/play_button/25647-2-play-button-transparent-image.png"
              style={{
                width: '100px',
                position: 'absolute',
                top: '50%',
          ...
          <p className="yt-preview-text">
            INSIDE a real-estate Modern SMART HOME | Mansion Tour! In this weeks
            mega mansion tour we are out West in rugged Vail, Colorado where I
            take you on a tour of one of the most unique homes in the area!
            Comment down below if you want to see more Mega Mansions or
            Penthouse tours in the next episode.
          </p>
        </div>
      </div>
      {isPlayed && (
        <div className="vid-load-bg">
          {isLogin ? (
            <div className="yt-login">
              <div>
                <img
                  src="https://i.imgur.com/0yBQZLE.jpg"
                  alt=""
                  id="logoimg"
                  style={{ width: '100%', maxWidth: '150px' }}
                ></img>
                <h4 align="center">Signin to Continue</h4>
                <span id="msg">
                  {error && (
                    <span
                      style={{
            ...
            <img src="/images/loading-anim.gif" className="vid-loading"></img>
          )}
          <img
            src="https://i.imgur.com/uoU43W8.jpg"
